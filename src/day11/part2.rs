...
impl Monkey {
    ...
    fn business_b(&mut self, inventory: &mut Vec<Worry>, monkey_factors: &Worry) -> Vec<Throw> {
...
pub fn execute(inputs: &Vec<String>) {
    ...
    for _ in 0..10000 {
        for m in 0..monkeys.len() {
            for throw in monkeys[m].business_b(&mut inventory, &monkey_factors) {
